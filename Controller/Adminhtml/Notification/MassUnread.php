...
/**
 * Mass mark as unread action
 */
class MassUnread extends Action implements HttpPostActionInterface
{
    /**
     * Authorization level
     */
    ...
    public function execute()
    {
        try {
            ...
            $this->messageManager->addSuccessMessage(
                __('A total of %1 notification(s) have been marked as unread.', $collectionSize)
            );
            ...
            $this->messageManager->addExceptionMessage(
                $e,
                __('An error occurred while marking notifications as unread.')
            );
        }
